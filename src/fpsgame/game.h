...
enum
{
    ...
    N_RACINGSTART, N_RACINGFINISHED, N_RACINGCHECKPOINT, N_RACINGLAP, N_RACINGINFO,
    N_SERVCMD,
...
static const int msgsizes[] =               // size inclusive message token, 0 for variable or not-checked sizes
{
    ...
    N_RACINGSTART, 0, N_RACINGFINISHED, 0, N_RACINGCHECKPOINT, 2, N_RACINGLAP, 2, N_RACINGINFO, 7,
    N_SERVCMD, 0,
