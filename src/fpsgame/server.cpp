...
namespace server
{
    ...
    void setdemotime(const char *time)
    {
        ...
        int timeleft = game::maplimit - lastmillis;
    ...
    void changemap(const char *s, int mode)
    {
        ...
        gamemode = mode;
        gamemillis = 0;
        gamelimit = (m_overtime ? 15 : m_halftime ? 5 : 10)*60000;
        interm = 0;
        nextexceeded = 0;
